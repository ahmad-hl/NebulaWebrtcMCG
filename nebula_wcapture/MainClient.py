...
if __name__ == '__main__':
    ...
    hdlr_3 = logging.FileHandler(delay_log_url)
    latency_logger.setLevel(logging.INFO)
    latency_logger.addHandler(hdlr_3)
    ...
    hdlr_5 = logging.FileHandler(bw_log_url)
    ...
    hdlr_4 = logging.FileHandler(fps_log_url)
    fps_logger.setLevel(logging.INFO)
    fps_logger.addHandler(hdlr_4)
    ...
    hdlr_5 = logging.FileHandler(event_log_url)
    event_logger.setLevel(logging.INFO)
    event_logger.addHandler(hdlr_5)
    ...
    hdlr_6 = logging.FileHandler(plr_log_url)
    plr_logger.setLevel(logging.INFO)
    plr_logger.addHandler(hdlr_6)
