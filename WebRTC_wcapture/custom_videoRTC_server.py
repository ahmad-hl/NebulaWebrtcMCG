...
class CustomVideoRTCServer(VideoStreamTrack):
    ...
    def __init__(self, in_queue=None, out_queue=None,  render_logger=None, source=None):
        ...
        # Media source: screen sharing
            ...
            options = {"top": 0, "left": 0, "width": 1920, "height": 1080, "resolution": (1280, 720),
    ...
    async def recv(self):
        ...
        self.render_logger.info("{}, {}, {}, {}".format(self.frame_no, (time.time()-start) * 1000, time_base, pts))
        self.frame_no += 1
        self.fps += 1
